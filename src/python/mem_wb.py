...
def mem_wb_v(clk, reset, w_reg_ctl_in, mem_to_reg_in, mux_ctl_in, mem_data_in, alu_result_in, pc_value_in, w_reg_addr_in, 
             w_reg_ctl_out, mem_to_reg_out, mux_ctl_out, mem_data_out, alu_result_out, w_reg_addr_out, pc_value_out):
    """mem_wb: Memory/Writeback pipeline latch
    :param clk: clock (input)
    :param reset: reset signal
    :param w_reg_ctl_(in/out): write register control signal
